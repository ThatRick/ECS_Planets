...
export type PickableRenderer = System & {
    ...
    /** True when browser geolocation has produced a user position fix. */
...
export function createPlanetRendererWebGL(canvas: HTMLCanvasElement): PickableRenderer {
    ...
    const renderer: PickableRenderer = {
        ...
        get hasUserLocation(): boolean { return hasUserLocation > 0 },
        ...
        update(world: World, _dt: number): void {
            ...
            let largestId: number | undefined = undefined
